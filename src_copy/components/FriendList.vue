<template>
  <div id="friend">
    ...
    <div class="account-l fl">
      <!--切换-->
      <ul class="m_lei">
        <li class="m_lei_yi{{current_active=='company'?' m-active':''}}" @click="choose('company')"><img src="dist/images/m-chat.png" /></li>
        <li class="m_lei_er{{current_active=='group'?' m-active':''}}" @click="choose('group')"><img src="dist/images/group.png" /></li>
        <div class="m-add">
          <p @click="groupShow = true">+</p>
          <ul v-show="groupShow">
    ...
    <!--搜索页面-->
    <search-dialog v-show="panelShow.searchShow" :serchList="searchList"></search-dialog>
  </div>
</template>
<script>
