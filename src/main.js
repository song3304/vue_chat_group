...
new Vue({
  ...
  template: `<div id="chat_app">
		    ...
		    <echart :user="user" :userList="userList" :groupList="groupList" :companyLists="companyList" @sendGroupMsgEvent="sendGroupMsg" @createGroupEvent="createGroup" @delGroupEvent="delGroup"></echart>
