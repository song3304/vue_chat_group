  ...
  methods: {
    ...
    updateData: function (data) {
      ...
      if (data.hasOwnProperty('recentList')) {
        ...
        this.$refs.friend_list.$forceUpdate()
      }
      if (data.hasOwnProperty('bidList')) {
        this.bidList = data.bidList
        this.$refs.echarts.$forceUpdate()
      }
