...
<template>
  <ul>
    <li v-for="companyItem in companyList" :class="{'vu_accordion_li': companyItem.isCalling}">
        <div class="vu_link"><i class="fa fa-caret-right"></i><span class="vu_first_title ">{{companyItem.groupName}}</span><span>{{companyItem.onlineCnt}}/{{companyItem.userIds.length}}</span></div>
