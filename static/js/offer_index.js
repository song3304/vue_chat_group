	...
	this.render = function(obj){
		...
		for(var i=0;i<this.length_cnt;i++){
            if (i>=this.sell_price.length){//i<this.sell_price.length
                var html = '<li><div class="row">'+'<div class="col-md-4 col-xs-4 no-padding-r no-padding-r-mai no-padding-r-sell">卖'+(i+1)+'</div><div class="col-md-4 col-xs-4 no-padding-r no-padding-r-price" style="color:#00d700;text-align:center;padding:0;width:24%;">'+'--'+'</div>'+'<div class="col-md-4 col-xs-4 no-padding-r no-padding-r-amount" style="color:blue;text-align:center;">&nbsp;&nbsp;'+'--'+'</div>'+'</div></li>';
            } else {
                var html = '<li><div class="row">'+'<div class="col-md-4 col-xs-4 no-padding-r no-padding-r-mai no-padding-r-sell">卖'+(i+1)+'</div>'+'<div class="col-md-4 col-xs-4 no-padding-r no-padding-r-price no-padding-r-price-sell" style="color:#00d700;width:20%;text-align:right;">'+parseInt(this.sell_price[i].trade_price)+'</div>'+'<div class="col-md-4 col-xs-4 no-padding-r no-padding-number no-padding-r-amount" style="color:blue;text-align:right;padding:0;">&nbsp;&nbsp;'+((parseInt(this.sell_price[i].trade_amount)==0 || this.sell_price[i].trade_amount=='')?'500':this.sell_price[i].trade_amount)+'</div>'+
		...
		for(var i=0;i<this.length_cnt;i++){//i<this.buy_price.length
            if (i>=this.buy_price.length){
                var html = '<li><div class="row">'+'<div class="col-md-4 col-xs-4 no-padding-r no-padding-r-mai no-padding-r-buy">买'+(i+1)+'</div><div class="col-md-4 col-xs-4 no-padding-r no-padding-r-price" style="color:red;text-align:center;padding:0;width:24%;">'+'--'+'</div>'+'<div class="col-md-4 col-xs-4 no-padding-r no-padding-r-amount" style="color:blue;text-align:center;">&nbsp;&nbsp;'+'--'+'</div>'+'</div></li>';
            } else {
                var html = '<li><div class="row">'+'<div class="col-md-4 col-xs-4 no-padding-r no-padding-r-mai no-padding-r-buy">买'+(i+1)+'</div>'+'<div class="col-md-4 col-xs-4 no-padding-r no-padding-r-price no-padding-r-price-sell" style="color:red;width:20%;text-align:right;">'+parseInt(this.buy_price[i].trade_price)+'</div>'+'<div class="col-md-4 col-xs-4 no-padding-r no-padding-number no-padding-r-amount" style="color:blue;text-align:right;padding:0;">&nbsp;&nbsp;'+((parseInt(this.buy_price[i].trade_amount)==0 || this.buy_price[i].trade_amount=='')?'500':this.buy_price[i].trade_amount)+'</div>'+
                        '<div class="col-md-1 col-xs-1 tubiao" style="height:22px;padding-right:0;padding-left:6px;width:10%;padding-top: 2px;"><a class="detail-a">'+'<i class="fa fa-icon-gengduo" style="font-size:20px;font-weight:600;color:#666666;"></i>'+
	...
	this.rendermobile= function(obj){
		...
		for(var i=0;i<this.length_cnt;i++){
            if (i>=this.sell_price.length){//i<this.sell_price.length
                ...
                var html = '<li><div class="row">'+'<div class="col-md-4 col-xs-4 no-padding-r no-padding-r-mai no-padding-r-msell">卖'+(i+1)+'</div>'+'<div class="col-md-4 col-xs-4 no-padding-r no-padding-r-price" style="color:#00d700;width:20%;text-align:right;">'+parseInt(this.sell_price[i].trade_price)+'</div>'+'<div class="col-md-4 col-xs-4 no-padding-r no-padding-number no-padding-r-amount" style="color:blue;text-align:right;padding:0;">&nbsp;&nbsp;'+((parseInt(this.sell_price[i].trade_amount)==0 || this.sell_price[i].trade_amount=='')?'500':this.sell_price[i].trade_amount)+'</div>'+
	...
	this.renderDync = function(dyncObj){
        ...
        for(var i=0;i<temp_push_price.length;i++){
            ...
            var html = '<li>';
                ...
                html+='			<span class="'+(parseInt(item.trade_type)==1?'vue-realtime-buy vue-realtime-buy_price':'vue-realtime-sell vue-realtime-sell_price')+'"><b class="vue-realtime-buy_mai">'+parseInt(item.trade_price)+'</b></span>';
